...
var comment= document.createElement("span");
        ...
        document.getElementById('comment').innerHTML ='{panel:title=|borderStyle=dashed|borderColor=#ccc|titleBGColor=#4B8B3B|bgColor=#DE350B}*Regression test complete with issues*{panel}<br>'+
        '||*URLs:*||  |<br>'+
        '||*Evidence:*||  |<br>'+
        '||*Pending tickets:*||  |<br>';
